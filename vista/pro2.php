...
<html lang="en">
    ...
    <div class="row px-xl-5">
        ...
        <div class="col-lg-7 pb-5">
            <h3 class="font-weight-semi-bold">Gorra Snapback</h3>
            <div class="d-flex mb-3">
                ...
                <small class="pt-1">(75 Reseñas)</small>
            </div>
            <h3 class="font-weight-semi-bold mb-4">$65.000</h3>
            <p class="mb-4">La Gorra Snapback es el accesorio perfecto para complementar tu estilo urbano. Con su diseño clásico y moderno, ofrece un ajuste cómodo y personalizable, ideal para cualquier ocasión. Su visera plana y estructura reforzada la hacen un elemento distintivo en tu atuendo.</p>
            <div class="d-flex mb-3">
                <p class="text-dark font-weight-medium mb-0 mr-3">Talla:</p>
                <form>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" class="custom-control-input" id="size-unica" name="size" checked>
                        <label class="custom-control-label" for="size-unica">Única</label>
                    </div>
                </form>
            </div>
    ...
    <div class="row px-xl-5">
        <div class="col">
            <div class="nav nav-tabs justify-content-center border-secondary mb-4">
                ...
                <a class="nav-item nav-link" data-toggle="tab" href="#tab-pane-3">Reseñas (75)</a>
            </div>
            <div class="tab-content">
                <div class="tab-pane fade show active" id="tab-pane-1">
                    <h4 class="mb-3">Descripción del Producto</h4>
                    <p>La **Gorra Snapback** es un ícono del estilo callejero y deportivo. Con su diseño estructurado y visera plana, aporta un toque de autenticidad a cualquier atuendo. Ideal para protegerte del sol o simplemente para realzar tu look diario.</p>

                    <p>Fabricada con materiales de alta calidad, garantiza **durabilidad y confort**. Su sistema de ajuste trasero tipo "snapback" permite adaptar la gorra a diferentes tamaños de cabeza, asegurando un **ajuste perfecto y seguro**.</p>

                    <p>Perfecta para el uso diario, eventos deportivos o simplemente para expresar tu personalidad. ¡Haz de esta gorra tu complemento esencial!</p>
                </div>
                <div class="tab-pane fade" id="tab-pane-2">
                    <h4 class="mb-3">Información Adicional</h4>
                    <p>
                        Material: Algodón y poliéster de alta calidad<br>
                        Diseño: Estructura de 6 paneles, visera plana<br>
                        Ajuste: Cierre trasero tipo snapback (ajuste a presión)<br>
                        Tamaño: Talla única, adaptable a la mayoría<br>
                        Ventilación: Ojales bordados para mayor transpirabilidad
                    </p>
                    <div class="row">
                        <div class="col-md-6">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item px-0">
                                    Estilo: Urbano, deportivo, casual
                                </li>
                            </ul>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="tab-pane fade" id="tab-pane-3">
                    <div class="row">
                        <div class="col-md-6">
                            <h4 class="mb-4">1 reseña para "Gorra Snapback"</h4>
                            <div class="media mb-4">
                                <img src="img/user.jpg" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
                                <div class="media-body">
                                    <h6>Carlos R. <small> - <i>20 Junio 2025</i></small></h6>
                                    ...
                                    <p>¡Excelente gorra! El material es muy bueno y el ajuste perfecto. La uso casi todos los días y sigue como nueva. El diseño es tal cual la foto, muy contento con la compra. La recomiendo.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
